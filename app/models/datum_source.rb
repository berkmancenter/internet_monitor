class DatumSource < ActiveRecord::Base
    attr_accessible :admin_name, :default_weight, :description, :in_category_page, :in_sidebar, :requires_page, :normalized, :is_api, :source_name, :source_link, :max, :min, :public_name, :retriever_class, :datum_type, :affects_score, :display_prefix, :display_suffix, :precision
