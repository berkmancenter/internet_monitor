...
#    Country.calculate_scores_and_rank!
  ...
  task :import_country_widgets => [:environment] do |task|
    ...
    countries = [
      ...
      [ 'ure', 'ZntsmcQjxSQNNuLQD', %|[{"mid":"5GnwdA2om6Ctq2naQ","cx":2,"cy":1,"row":7,"col":3},{"mid":"mBZQtjqbD4qQX78Cf","cx":2,"cy":1,"row":6,"col":3},{"mid":"vCJPXXkivJj3ooRY7","cx":2,"cy":1,"row":6,"col":1},{"mid":"EnuKMmkDWe4jYK4gh","cx":4,"cy":1,"row":3,"col":1},{"mid":"wkjvJtnbLSBnf46YA","cx":2,"cy":1,"row":7,"col":1},{"mid":"asnfYYZjTZjhWGyrQ","cx":2,"cy":1,"row":4,"col":1},{"mid":"tpA2YaHanH2WsTqEc","cx":2,"cy":2,"row":8,"col":1},{"mid":"kG74MQhLi8nxTT3xZ","cx":4,"cy":1,"row":5,"col":1},{"mid":"5KoHhYhgBBk4JJukK","cx":4,"cy":2,"row":1,"col":1},{"mid":"ZmPhvkzjACK6qwBqF","cx":2,"cy":1,"row":4,"col":3}]| ],
